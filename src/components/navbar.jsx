...
export const Navbar = () => {
    ...
    const [buttoDisabled, setButtonDisabled] = useState(false);
    useEffect(() => {
        if (location.pathname.includes("create-project") || location.pathname.includes("edit-project")) {
        ...
        <header className='sp-nav-header'>
            <nav className='sp-navbar'>
                ...
                <div className='sp-nav-btn-box'>
                    <button className='sp-btn sp-btn-vl' onClick={() => navigate('/create-project')} disabled={buttoDisabled}>
